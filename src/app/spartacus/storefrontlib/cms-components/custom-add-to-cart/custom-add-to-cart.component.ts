...
import {ActiveCartService, CmsAddToCartComponent, isNotNullable, Product, I18nModule } from '@spartacus/core';
import { Observable, Subscription } from 'rxjs';
import { filter, map, take } from 'rxjs/operators';
import { CurrentProductService, ModalService, ModalRef, CmsComponentData } from '@spartacus/storefront';
...
export class CustomAddToCartComponent implements OnInit {
  ...
  addToCartForm:any = new FormGroup({
  ...
  constructor(
    ...
    component: CmsComponentData<CmsAddToCartComponent | any>
  );
